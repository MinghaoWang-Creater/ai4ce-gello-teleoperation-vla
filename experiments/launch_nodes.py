...
def launch_robot_server(args: Args):
    ...
    if args.robot == "sim_ur":
        ...
        if args.robot == "xarm7":
            from gello.robots.xarm_robot import XArm7Robot

            robot = XArm7Robot(ip=args.robot_ip)
        if args.robot == "xarm6":
            from gello.robots.xarm_robot import XArm6Robot

            robot = XArm6Robot(ip=args.robot_ip)
        elif args.robot == "ur":
