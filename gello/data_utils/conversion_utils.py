...
def preproc_obs(
    ...
    # c h w
    # TODO: I commented out a lot of code here, because I don't have the wrist camera
    ...
    rgb_wrist = demo.get("base_rgb").transpose([2, 0, 1]) * 1.0  # type: ignore
    depth_wrist = demo.get("base_depth").transpose([2, 0, 1]) * 1.0  # type: ignore
